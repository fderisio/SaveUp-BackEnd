...
insert into income(id, user_id, income, started_at, monthly) values (1L, 1L, 8000, '01.01.2017', true);
insert into income(id, user_id, income, started_at, monthly) values (2L, 2L, 5000, '01.01.2017', true);
...
insert into expense(id, category_id, description, store, exp_date, total, payment_method_id) values 
