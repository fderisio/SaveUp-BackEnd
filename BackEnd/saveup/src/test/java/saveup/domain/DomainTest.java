...
public class DomainTest {
	...
	public void IncomeTest() {
		...
		assertThat(income.getUser().getFirstName()).isEqualTo("Carol");
	}
	...
	public void PayMethodTest() {
		...
		assertThat(payMethod.getName()).isEqualTo("Visa");
	}
	...
	public void ExpenseTest() {
		...
		assertThat(expense.getCategory().getUser().getLastName()).isEqualTo("Jackson");
	}
